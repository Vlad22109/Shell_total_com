...
OutputDir=..\..\..\Setup
OutputBaseFileName=setup1.0.0.0
...
; Исполняемый файл
Source: "..\..\..\WpfApplication1\bin\Release\WpfApplication1.exe"; DestDir: "{app}"; Flags: ignoreversion

; Прилагающиеся ресурсы
Source: "..\..\..\WpfApplication1\bin\Release\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
begin
    ...
    success := false;
    reg_key := 'SOFTWARE\Microsoft\NET Framework Setup\Sh\';
...
;------------------------------------------------------------------------------
Filename: {tmp}\dotNetFx40_Full_setup.exe; Parameters: "/q:a /c:""install /l /q"""; Check: not IsRequiredDotNetDetected; StatusMsg: Microsoft Framework 4.5 is installed. Please wait...